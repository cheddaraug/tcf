...
const CircularText = ({
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`mx-auto rounded-full lg:w-[150px] lg:h-[150px] hidden text-dark-brown lg:block font-black font-primary text-center cursor-pointer origin-center ${className}`}
      animate={controls}
