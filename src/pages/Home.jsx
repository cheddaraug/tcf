  ...
  return (
    <>
      <div>
        ...
        <div className="flex flex-col justify-center items-center  text-center text-4xl  lg:text-6xl px-6 lg:px-12 pt-12 pb-8 h-[50vh] lg:h-[80vh]"  id="explore">
          ...
          <h2 className="font-primary text-dark-brown">Purposeful design. <br />
         <span className="text-black"> Empowering brands to thrive</span></h2>
        </div>
        ...
        <div
          className={`bg-primary mt-12 px-6 lg:px-12 pt-12 pb-8`}
        >
        ...
        <div className="lg:w-1/2 mt-12 px-6 lg:px-12 pt-12 pb-8">
            ...
            >
             From fresh ideas to established names, this is for anyone ready to make an impact online. Startups, growing brands, schools, creatives, and everything in between — if there's a vision, there's a way to build it.
            </p>
          </div>
