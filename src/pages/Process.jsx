...
const process = [
  {
    ...
    steps: [
      { sub: 'Interrogation (Initial Consultation):', desc: 'You talk. We listen. And yes, we’re taking notes.' },
      { sub: 'Competitive Intel (Market Analysis):', desc: 'We find out what your rivals are doing. Then outdo them.' },
      { sub: 'User Profiling (User Research):', desc: 'We get inside your users’ heads—legally, mostly.' }
    ]
  },
  {
    image: designImage,
    ...
    steps: [
      { sub: 'Blueprint Mode (Wireframing):', desc: 'Boxes, grids, logic. Not sexy, but essential.' },
      { sub: 'Visual Strategy (Design Direction):', desc: 'Your brand, but turned up to 11.' },
      { sub: 'UX Thinking:', desc: 'Designed for humans, not committee meetings.' }
    ]
  },
  {
    ...
    steps: [
      { sub: 'Custom Code:', desc: 'Built from scratch. Just like grandma’s lasagna.' },
      { sub: 'Speed & Responsiveness:', desc: 'Because no one waits for slow sites.' },
      { sub: 'Cross-Device Testing:', desc: 'It’ll look good everywhere—yes, even on that weird Android phone.' }
    ]
  },
  {
    image: reviewImage,
    ...
    steps: [
      { sub: 'First Reveal:', desc: 'Your first look. Prepare to be impressed.' },
      { sub: 'Feedback Loop:', desc: 'Tell us what you love and what you… don’t.' },
      { sub: 'Refinements:', desc: 'Better, sharper, tighter. We iterate until it’s elite.' }
    ]
  },
  {
    image: launchImage,
    ...
    steps: [
      { sub: 'Deployment:', desc: 'No crashes. No chaos. Just clean launches.' },
      { sub: 'Domain & DNS:', desc: 'Yes, we’ll handle that boring stuff too.' },
  ...
  },
  {
    ...
    steps: [
      { sub: 'Maintenance & Updates:', desc: 'Keep it fresh, fast, and bug-free.' },
      { sub: 'Support Requests:', desc: 'Something broke? We’ll fix it.' },
      { sub: 'Growth Tracking:', desc: 'Your site’s alive. Let’s help it evolve.' }
    ]
  }
];
      ...
      <div className="">
        <div className=" px-6 lg:px-12 pt-12 pb-8 bg-gradient-to-b from-tan to-white">
          ...
          <div className="flex justify-between items-start mt-8">
            ...
            Behind every sleek website is a process—ours just happens to be smarter, faster, and slightly more obsessive than most. Here’s how we turn ideas into digital powerhouses.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 lg:px-12 font-primary font-bold text-2xl lg:text-5xl  pt-12 lg:pt-24  ">
          ...
          We prioritize bold ideas, brutal honesty, and pixel-perfect execution — collaboration is just a bonus.
          </h2>
          </div>

        <div className=" px-6 lg:px-12 flex flex-col mt-6 gap-12 lg:gap-24">
          {process.map((item, index) => <ProcessCard processData={item} key={index} index={index}/>)}
        </div>
