...
const Contact = () => {
  ...
  useEffect(() => {
    document.title =
      "Summon Us | We don’t bite. Unless provoked - The Code Factory";
  }, []);
    ...
    <>
      <div className="px-6 pt-8 lg:px-12 ">
        <div className="flex flex-col gap-4 lg:w-[50%] ">
          <p className="font-primary font-bold text-primary text-5xl upper lg:text-7xl">
            Contact
          </p>
          <p className="font-semibold text-gray text-lg lg:text-xl">
            We know—this is the part where you “reach out.” Whether it’s a
            question, a quote, or a late-night existential crisis about your
            digital presence, go ahead. Hit us up. Just don’t send “hi” and
            ghost.
          </p>
        </div>
        ...
        <div className="font-primary flex flex-col gap-4 py-12 perspective-[1000px] ">
          {links.map((link, index) => (
            <motion.a
              ...
              animate={hovered === index ? { rotateY: -2 } : { rotateY: 0 }}
